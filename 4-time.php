...
$query = mysql_query("SELECT rtt_qos,tp_qos,p_qos,P1203,intID,intExpID,intUser from dashoutput  where rtt_qos!=0 and intExpID= ".$exp_ID." and intUser= ".$user." order by intSeg asc");
$array = array();
...
while($results = mysql_fetch_assoc($sql)){
	...
	for($j = 0; $j<4; $j++ ){
		...
		<tr>
			...
			<th><?php echo (int)avgReturn($f_0, 20, 'P1203'); ?></th>
		</tr>
		...
		<?php }elseif($j==1){?>
			...
			<th><?php echo (int)avgReturn($f_1, 20, 'P1203'); ?></th>
		</tr>
		...
		<?php }elseif($j==2){?>
			...
			<th><?php echo (int)avgReturn($f_2, 20, 'P1203'); ?></th>
		</tr>
		...
		<?php }elseif($j==3){?>
				...
				<th><?php echo (int)avgReturn($f_3, 20, 'P1203'); ?></th>
				</tr>
